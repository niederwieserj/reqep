Feature: Standorte erstellen
  ...
  Scenario: Ladepunkt erstellen
    When der Betreiber einen neuen Ladepunkt erstellt mit ID LP0001, Charging Mode AC und Status FREE
    Then hat der neue Ladepunkt die ID LP0001, Charging Mode AC und Status FREE
